...
{
	// shared_from_this은 스마트 포인터의 this
	// 해당 class는 enable_shared_from_this<class이름>를 상속해야 함.
	...
	{
		// dynamic_pointer_cast : 스마트 포인터 버전의 dynamic_cast
		_scripts.emplace_back(dynamic_pointer_cast<MonoBehaviour>(component));
	}
}
